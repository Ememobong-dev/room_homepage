    ...
    <div>
      ...
      <div>
        <Row>
          <Col lg={7} xxl={8}>
            <span>
              <Image fill src={subHero1} className="w-full h-full" alt="sub-hero" />
            </span>
          </Col>
          <Col lg={10} xxl={8}>
            <div className="bg-white w-full h-full ">
              <div className="flex flex-col justify-center text-black md:p-14 items-center">
                <div>
                  <h2 className="font-bold uppercase tracking-[0.5em] text-xl">
                    About our funitures
                  </h2>
                  <p className="my-5 text-lg text-darkGray">
                    About our furniture Our multifunctional collection blends
                    design and function to suit your individual taste. Make each
                    room unique, or pick a cohesive theme that best express your
                    interests and what inspires you. Find the furniture pieces
                    you need, from traditional to contemporary styles or
                    anything in between. Product specialists are available to
          ...
          <Col lg={7} xxl={8}>
            <span>
              <Image fill src={subHero2} className="w-full h-full" alt="sub-hero" />
            </span>
          </Col>
        </Row>
      </div>
